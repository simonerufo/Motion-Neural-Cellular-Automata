...
| **Phase 2: Ecosystem & Mitosis**<br>Random exploration and life cycle | ![](gifs/phase2_ecosystem_giraffa.gif) | ![](gifs/phase2_ecosystem_jelly.gif) | ![](gifs/phase2_ecosystem_salamandra.gif) |
...
**windows support:**
```bash
./run.bat [ACTION] [EXPERIMENT] [TARGET_IMAGE]
```
*Otherwise:* 
```bash
...
* **Save gif:** it is possible to save gifs visualized while testing using the optional flag --save_gif running the run script.
